...
public class OrderConstants {
    public static final String BOOK_IDS_IS_REQUIRED = "The order must contain at least one valid book";
    public static final String TOTAL_AMOUNT_IS_REQUIRED = "Total amount is required";
    ...
    public static final String CUSTOMER_ID_NOT_FOUND = "Customer id does not exist";
